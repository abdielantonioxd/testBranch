...
BEGIN
	...
	FROM
		...
		ON n.nannyID = img.nannyID
	WHERE
		  ndt.serviciosAdicionales   IN (_data)
		AND ndt.exp = _experiencia;
...
-- Dump completed on 2019-08-08 19:04:21
