...
--
-- Host: 127.0.0.1    Database: nanny365
-- ------------------------------------------------------
...
BEGIN
	...
	WHERE
        ndt.exp = _experiencia
        AND  ndt.serviciosAdicionales   IN (_data);
	ELSE
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_filterRange`(in _dataOne int(11),
 in _dataTwo int (11),
 in _exp int (11), 
...
-- Dump completed on 2019-08-09 18:48:23
