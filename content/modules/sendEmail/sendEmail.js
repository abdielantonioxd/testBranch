  ...
  async function main() {
    ...
    let mailOptions = {
      ...
      <span style="font-size: 16px; line-height: 32px;">
       <a style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#AB09B0;" href="https://www.nanny365.app/recuperar-password?autenticateUser=${hasAutenticate}">Recuperar Contraseña</a>
      </span>
      </span></button>
      ...
      <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><a href="https://www.nanny365.app/" target="_blank"> <img align="center" alt="Image" border="0" class="center fixedwidth" src="https://www.nanny365.app/images/hard.png" style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; height: auto; float: none; border: none; width: 100%; max-width: 114px; display: block;" title="Image" width="114"/></a>
      <!--[if mso]></td></tr></table><![endif]-->
      </div>
      <!--[if (!mso)&(!IE)]><!-->
      </div>
